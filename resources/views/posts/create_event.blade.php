            ...
            <div class="panel-body" >
                <form id="eventform" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea rows="5" cols="114" style="resize:none" placeholder="Enter a brief description"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="organiser" value="{{ Auth::user()->name }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-offset-3 col-md-9">
                            <button id="btn-signup" type="button" class="btn btn-info btn-block"><i class="icon-hand-right"></i>Post event</button>
                        </div>
                    </div>
                </form>
            </div>
